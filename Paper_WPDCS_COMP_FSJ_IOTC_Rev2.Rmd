...
```{r runnning-CAPTURE-QUANTITY-REV3, include=FALSE}
...
```{r filteringoniotcspeciesandintersect, include=FALSE}
...
```{r presenceabsencecreation, include=FALSE}
...
```{r iotcspecieslevelanalysiscreation}
...
```{r fleetbreakdownbigeyeeasterncreation}
...
```{r fleetbreakdownbigeyetotalcreation}
...
```{r verifalb2015creation, tab.cap="Major differences break down by fishing_fleet between FishStat and GTA for albacore tuna data catches for year 2015"}
...
```{r bigeyewesterwithoutindonesiacreation}
...
```{r Dominant-difference-category-by-species-a-yearcreation}
...
<!-- ```{r albacoretable2015, tab.cap="Major differences break down by fishing_fleet_label between less_1_pct datasets"} -->
